...
<template>
	<footer>
		<div class="footer">
			<div class="copyright">
				Copyright &copy; 2021{{ " - " + new Date().getFullYear() }} Kazem Moridi |
				<a href="https://www.apache.org/licenses/LICENSE-2.0">Open-source Apache Licensed</a>
				|
				<a href="/privacy">Privacy policy</a>
			</div>
			<div class="social">
				<a target="_blank" rel="noopener noreferrer" href="https://discord.gg/HBU6zD8c5v">
					<DiscordIcon />
					Discord
					<OutboundLink />
				</a>
				<a target="_blank" rel="noopener noreferrer" href="https://github.com/ireaderorg">
					<GithubIcon />
					GitHub
					<OutboundLink />
				</a>
